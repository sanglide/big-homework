...
public class CouponServiceImpl implements CouponService, CouponServiceForBl {
	...
	@Override
	public Coupon getCouponByUserAndAmountAndActivity(int userId, double amount, int activityId) {
		return couponMapper.selectCouponByUserAndAmountAndActivity(userId, amount, activityId);
	}
